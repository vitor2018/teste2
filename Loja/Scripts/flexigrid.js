...
(function ($) {
    ...
    $.addFlex = function (t, p) {
        ...
        p = $.extend({ //apply default properties
            ...
            errormsg: 'Erro de Conex&atildeo',
            usepager: false,
            nowrap: true,
            page: 1, //current page
            total: 1, //total pages
            ...
            rpOptions: [10, 50, 100, 500, 1000], //allowed per-page values
            title: false,
            idProperty: 'id',
            pagestat: 'Exibindo {from} at&eacute {to} de {total} registros',
            pagetext: 'P&aacutegina',
            outof: 'de',
            findtext: 'Buscar',
